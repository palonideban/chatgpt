...
var CommandDescriptions = map[Command]string{
	CommandHelp:     "Membantu tim",
	CommandHistory:  "Tunjukkan sejarah korespondensi",
	CommandRollback: "Batalkan Pesan Terakhir",
	CommandClear:    "Bersihkan Sejarah Korespondensi",
}
